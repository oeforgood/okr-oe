...
function MessagesPanel({managerNotifs,teammateNotifs=[],onReadNotif,teamMember,teamMembers=[],myUpdates=[]}){
  ...
  return <div style={{background:"#fff",borderRadius:10,border:"1px solid #e2ddd6",boxShadow:"0 1px 3px rgba(0,0,0,.06)",display:"flex",flexDirection:"column",height:150,overflow:"hidden"}}>
...
function FeedbackBox({currentUser, teamMember}) {
  ...
  return (
    <div style={{background:"#fff",border:"1px solid #e2ddd6",borderRadius:10,padding:"10px 14px",
      boxShadow:"0 1px 3px rgba(0,0,0,.06)",display:"flex",flexDirection:"column",gap:6,height:150,boxSizing:"border-box"}}>
